...
import { VisibiltyToolbar, AddTodoForm, TodoList } from './components';
  ...
  render(){
    ...
    return (
      <div className="app">
        ...
        <VisibiltyToolbar visibilityType={visibility} onVisibilityChange={this.handleVisibilityChange.bind(this)} />
        ...
        { visibleTodos && showClearCompleted && hasCompleted && (
            <span className='btn-clear-all' onClick={this.handleRemoveCompleted.bind(this)}>Clear Completed</span>
        )}
      </div>
    );
  }
