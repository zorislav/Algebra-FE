          ...
          case 8:
            ...
            if (retData.length !== 0) {
              ...
              for (i in retData) {
                ...
                if (retData[i].artist && retData[i].song && reData[i].artwork) {
                  // Kreiraj li element
...
},{"./data.js":2,"./render.js":4}],4:[function(require,module,exports){
"use strict";
...
var createElement = function createElement(songData) {
  ...
  listItemP.innerHTML = "".concat(songData.artist, " - ").concat(songData.song).concat(songData.artwork);
