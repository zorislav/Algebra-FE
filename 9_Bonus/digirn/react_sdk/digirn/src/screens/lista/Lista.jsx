            ...
            {Object.keys(fireNalozi).map((nalog, index) => {
              return (
                <tr key={index} onClick={() => {odabranNalog(nalog)}}>
                  ...
                  <td className={styles["table-col-hide"]}>{fireNalozi[nalog].datumNaloga}</td>
                  <td className={styles["table-col-hide"]}>{fireNalozi[nalog].datumPocetka}</td>
                  <td className={styles["table-col-hide"]}>{fireNalozi[nalog].datumZavrsetka}</td>
                  <td>{fireNalozi[nalog].narucitelj}</td>
                  <td>{fireNalozi[nalog].izvrsitelj}</td>
                  <td className={styles["table-col-hide"]}>{fireNalozi[nalog].naslov}</td>
                </tr>
              );
            })}
          </tbody>
        </table>
        { nemaNaloga && <p className={styles["nema-naloga"]}>Nema naloga</p> }
      </section>
    </>
  );
} 