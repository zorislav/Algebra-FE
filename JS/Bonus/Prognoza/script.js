// Deklaracija konstanti za pristup elementima
...
// Deklaracija nizova za dane u tjednu i mjesece u godini
...
function displayDate(tzOff) {
  ...
  // ako postoji timezone_offset pretvori ga iz sekunda u minute i apliciraj na tekuće vrijeme
...
function showWeatherData (data){
  ...
  data.daily.forEach((day, idx) => {
    if(idx == 0){
      ...
      // Postavi prikaz za idućih 7 dana
      otherDayForcast += `
...
// Za upisanu lokaciju procitaj koordinate
